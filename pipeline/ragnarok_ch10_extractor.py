"""
pipeline/ragnarok_ch10_extractor.py — Extract high-resolution strips from Solo Leveling: Ragnarok Chapter 10 PDF.
"""
...
PDF_PATH = Path(r"C:\Users\ABHAY MAURAYA\Downloads\Telegram Desktop\Chapter 10 - Solo Leveling_ Ragnarok.pdf")
if not PDF_PATH.exists():
    PDF_PATH = Path(r"C:\Users\ABHAY MAURAYA\.gemini\antigravity-ide\brain\a6075157-dcd6-4aff-ac56-7ed16bcded0b\.user_uploaded\media_1790334762794.pdf")

OUT_DIR = ROOT / "output" / "solo_leveling_ragnarok_ch10" / "raw_strips"
